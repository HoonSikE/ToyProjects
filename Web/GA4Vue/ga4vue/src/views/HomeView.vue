<template>
  <div>
    ...
    <div>
        ...
        <div class="a">
            <span class="b" @click="clickEvent(false)">
                클릭 이벤트 테스트<br/>
                (Event)
            </span>
        </div>
    ...
    <div>
        ...
        <div class="a">
            <span class="b" @click="viewItemList(false)">
                상품 리스트<br/>
                (ViewItemList)
            </span>
            <span class="b" @click="selectItem(false)">
                상품 클릭 테스트<br/>
                (SelectItem)
            </span>
            <span class="b" @click="viewItem(false)">
                상품 상세 정보 전송<br/>
                (ViewItem)
            </span>
            <span class="b" @click="addToWishlist(false)">
                위시 리스트<br/>
                (AddToWishlist)
            </span>
            <span class="b" @click="addToCart(false)">
                장바구니 담기<br/>
                (AddToCart)
            </span>
            <span class="b" @click="viewCart(false)">
                장바구니 상세 정보<br/>
                (ViewCart)
            </span>
            <span class="b" @click="removeFromCart(false)">
                장바구니 제거<br/>
                (RemoveFromCart)
            </span>
            <span class="b" @click="beginCheckout(false)">
                상품 구매<br/>
                (BeginCheckout)
            </span>
            <span class="b" @click="addShippingInfo(false)">
                배송 정보 입력<br/>
                (AddShippingInfo)
            </span>
            <span class="b" @click="addPaymentInfo(false)">
                상품 결제<br/>
                (AddPaymentInfo)
            </span>
            <span class="b" @click="purchase(false)">
                구매 완료<br/>
                (Purchase)
            </span>
            <span class="b" @click="refund(false)">
                상품 환불<br/>
                (Refund)
            </span>
        </div>
