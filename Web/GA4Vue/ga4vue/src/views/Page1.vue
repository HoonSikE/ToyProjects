<template>
  <div>
    <div>
        ...
        <div class="a">
            <span class="c" @click="clickEvent(true)">
                클릭 이벤트 테스트<br/>
                (Event)
            </span>
        </div>
    ...
    <div>
        ...
        <div class="a">
            <span class="c" @click="viewItemList(true)">
                상품 리스트<br/>
                (ViewItemList)
            </span>
            <span class="c" @click="selectItem(true)">
                상품 클릭 테스트<br/>
                (SelectItem)
            </span>
            <span class="c" @click="viewItem(true)">
                상품 상세 정보 전송<br/>
                (ViewItem)
            </span>
            <span class="c" @click="addToWishlist(true)">
                위시 리스트<br/>
                (AddToWishlist)
            </span>
            <span class="c" @click="addToCart(true)">
                장바구니 담기<br/>
                (AddToCart)
            </span>
            <span class="c" @click="viewCart(true)">
                장바구니 상세 정보<br/>
                (ViewCart)
            </span>
            <span class="c" @click="removeFromCart(true)">
                장바구니 제거<br/>
                (RemoveFromCart)
            </span>
            <span class="c" @click="beginCheckout(true)">
                상품 구매<br/>
                (BeginCheckout)
            </span>
            <span class="c" @click="addShippingInfo(true)">
                배송 정보 입력<br/>
                (AddShippingInfo)
            </span>
            <span class="c" @click="addPaymentInfo(true)">
                상품 결제<br/>
                (AddPaymentInfo)
            </span>
            <span class="c" @click="purchase(true)">
                구매 완료<br/>
                (Purchase)
            </span>
            <span class="c" @click="refund(true)">
                상품 환불<br/>
                (Refund)
            </span>
        </div>
