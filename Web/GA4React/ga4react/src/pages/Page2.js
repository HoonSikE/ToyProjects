    ...
    return (
        <div>
            <div>
                ...
                <div class="a">
                    <span class="d" onClick={() => clickEvent(true)}>
                        클릭 이벤트 테스트<br/>
                        (Event)
                    </span>
                </div>
            ...
            <div>
                ...
                <div class="a">
                    <span class="d" onClick={() => viewItemList(true)}>
                        상품 리스트<br/>
                        (ViewItemList)
                    </span>
                    <span class="d" onClick={() => selectItem(true)}>
                        상품 클릭 테스트<br/>
                        (SelectItem)
                    </span>
                    <span class="d" onClick={() => viewItem(true)}>
                        상품 상세 정보 전송<br/>
                        (ViewItem)
                    </span>
                    <span class="d" onClick={() => addToWishlist(true)}>
                        위시 리스트<br/>
                        (AddToWishlist)
                    </span>
                    <span class="d" onClick={() => addToCart(true)}>
                        장바구니 담기<br/>
                        (AddToCart)
                    </span>
                    <span class="d" onClick={() => viewCart(true)}>
                        장바구니 상세 정보<br/>
                        (ViewCart)
                    </span>
                    <span class="d" onClick={() => removeFromCart(true)}>
                        장바구니 제거<br/>
                        (RemoveFromCart)
                    </span>
                    <span class="d" onClick={() => beginCheckout(true)}>
                        상품 구매<br/>
                        (BeginCheckout)
                    </span>
                    <span class="d" onClick={() => addShippingInfo(true)}>
                        배송 정보 입력<br/>
                        (AddShippingInfo)
                    </span>
                    <span class="d" onClick={() => addPaymentInfo(true)}>
                        상품 결제<br/>
                        (AddPaymentInfo)
                    </span>
                    <span class="d" onClick={() => purchase(true)}>
                        구매 완료<br/>
                        (Purchase)
                    </span>
                    <span class="d" onClick={() => refund(true)}>
                        상품 환불<br/>
                        (Refund)
                    </span>
                </div>
