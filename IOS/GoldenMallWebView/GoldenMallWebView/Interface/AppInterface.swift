...
//    case sendGAEvent
//    
//    case transactionFieldError
//}
//
//class AppInterface {
//    var gaData: [String: Any] = [:]
//
//    func sendGA(data: Any) throws {
//        do {
//            // MARK: data Type 점검 및 data 설정
//            // data 역할
//            let gaDict = data as? [String: Any] ?? [:]
//            // Bundle 역할
//            gaData = [:]
//            
...
//            
//            try setCustomData(dataForCustom: gaDict) // GA4 맞춤 데이터 설정
//            
//            // 앱 사용자 속성 고정값 처리
...
//                    try setTransactionData(gaDict: gaDict)    // 거래 데이터 처리
//                }
//                // 상품 데이터 설정
//                if gaDict["items"] != nil {
//                    try setItemsData(gaDict: gaDict)         // 아이템 데이터 처리
//                }
...
//                
//                case GAError.transactionFieldError:
//                    print("GA4_Error: 거래 데이터 확인 부탁드립니다.")
//                
//                default:
...
//    func setCustomData(dataForCustom: [String: Any]) throws {
//        do{
...
//    }
//    // MARK: 거래 데이터 설정 함수
//    func setTransactionData(gaDict: [String: Any]) throws {
//        do{
//            guard let dataForTransaction = gaDict["transaction"] as? [String: Any] else { throw GAError.transactionFieldError }
...
//    }
//    // MARK: 상품 데이터 설정 함수
//    func setItemsData(gaDict: [String: Any]) throws {
//        do{
...
//            
//    // MARK: 네이티브 공통 함수
//    func sendGAScreen(dataForScreen: [String: Any]) {
//        do {
//            var setData = dataForScreen
//            setData["type"] = "P"
//            try sendGA(data: setData)
//        } catch {
//            print("GA4_Error: sendGAScreen 함수 확인 부탁드립니다.")
//        }
//    }
//    
//    func sendGAEvent(dataForEvent: [String: Any]) {
//        do {
...
//    }
//    
//    func sendGAEcommerce(dataForEcommerce: [String: Any]) {
//        do {
